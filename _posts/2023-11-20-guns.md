...
Think about it. If I have a automatic rifle in my possession, and had to pick a movie theater in <span id="cycling-words-1" style="display: inline-block; width: 120px; background-color: blue; color: white;">Texas</span>, or in <span id="cycling-words-2" style="display: inline-block; width: 120px; background-color: red; color: white;">Wyoming</span>, which would I go for if I wanted to escape unscathed?
