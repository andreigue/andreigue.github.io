---
title: "Part 1 of Reading Nakedd Economics"
...
And this worked because it involved a relatively small number of people. But let’s be honest, private companies are not going to solve something like CO2 emissions on a national or global scale. It is just too big of a problem.

Now, let’s talk about how the government can help with these kinds of issues. Sure, the government can ban harmful practices or chemicals outright, but sometimes there are better ways to change behavior. Take the Hummer, for example. It is an absolute gas guzzler, yet some people still drive it to the grocery store instead of using something more efficient like a Honda Civic (assuming they have both cars in their garage). If the government wants to discourage people from buying/driving fuel-inefficient cars, what can they do?

One option is to tax them. You could use a gas/emissions tax, a weight tax, or even both. Make driving the Hummer more expensive, and suddenly fewer people will want one. It is as simple as that.

And it is not just about limiting behavior. It also brings in revenue. Instead of banning the Hummer outright, you can use that money to pay for the costs of climate change, like investing in R&D for alternative energy sources. Plus, if people know they will pay more for the extra weight and terrible fuel efficiency, they will think twice when they buy their next car. And thanks to competition in the market, car companies will have to adapt and start making vehicles that are lighter and more efficient.

But let's be real. Taxes are not always a perfect solution. First, how do you figure out the right amount to tax? Second, if you make driving big trucks and SUVs more expensive, only those who can afford it will keep doing it. And that usually means the rich. This kind of tax would end up punishing a struggling contractor who really needs his pickup truck to work and make a living.
...
Similarly, consider the example of Pfizer and its patent on Viagra. This book was written in 2013, and back then, Pfizer held the patent on Viagra, allowing it to set the price at $7 per pill, despite the production cost being only a fraction of that. The patent, guaranteed by the government, meant no other company could legally copy Pfizer's formula. Many may argue that this leads to inflated prices, but patents are crucial for encouraging innovation. Without the protection of a patent, other companies could immediately copy and sell Pfizer's product, making it impossible for Pfizer to recover the hundreds of millions of dollars spent on research and development (R&D).
...
"There is an old joke, one of Ronale Reagan's favorites, that goes something like this:
