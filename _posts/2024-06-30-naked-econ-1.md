...
That said, these countries have typically faced significatnt external pressure and economic sanctions from powerhouses such as the US, which have badly [affected them]. For example, Cuba has faced a U.S. embargo for decades, which has severely impacted its ability to trade and access resources.
